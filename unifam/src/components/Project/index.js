...
var ACCESS_CODE =
  "ya29.a0AfH6SMDZywY2TuC0zAGRY5UTUEvMG84kxBnc9N453e3wi-T-T5HgADBQ9PEJVriYLAChemXj0VHK9ZRyFhOdxLqzFbu3hwsc5pi6sFn-SrGu_mmauHPq0IecBJx8Y4HJldfXBEu1KW4kHDNBYu98uTyltlgd";
    ...
    return (
      <div>
        ...
        <div className="vertiflexC">
          ...
          <div className="playlisttheme">This week's theme: Productivity</div>
          ...
          <div>
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/videoseries?list=PL254fztT4JHiwo0r2v9FTuBhTWN4bjcWU"
          ...
          <div className="playlisttheme">Add a video to the playlist.</div>

          <form onSubmit={this.postVid.bind(this)}>
            <label className="formtext">
              <div className="formtext">Youtube URL:</div>
              <input
                type="text"
...
export default withAuthorization(condition)(MyFamily);
